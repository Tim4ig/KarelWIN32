...
// #include <stdbool.h>
// #include "karel.h" // looks like it don't need to be here
 ...
 */
enum direction { EAST = 0, NORTH = 90, WEST = 180, SOUTH = 270 };
 ...
 * Available colors
 */
enum Colors { RED_ON_BLACK = 1, YELLOW_ON_BLACK, WHITE_ON_BLACK };
